		...
		<div class="account_creation">
			...
			<div class="form-group">
				<label for="invoice_email">{l s='Invoice Email'}</label>
					<input type="text" class="validate form-control" data-validate="isEmail" id="invoice_email" name="invoice_email" value="{if isset($smarty.post.invoice_email)}{$smarty.post.invoice_email}{/if}" />
